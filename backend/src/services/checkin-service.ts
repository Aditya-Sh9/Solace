...
export function computeWeeklyStats(checkIns: CheckInSnapshot[]): WeeklyStats {
  const today      = getTodayUTC()
  ...
  if (recent.length === 0) return { avgMood: null, avgEnergy: null, avgSleep: null, daysLogged: 0 }
